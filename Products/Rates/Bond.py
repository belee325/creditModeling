...
class Bond(object):
    ...
    def getYield(self, bondScheduler ,start, end,referenceDate):
        faceValue = 1
        if coupon == 0:
            #no coupons return discounted facevalue at reference date
            self.bondYield = faceValue * self.libor[][]
        else:
            self.bondYield = faceValue
